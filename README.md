...
A simple PHP & MySQL based Recipe Sharing Web App where users can:-
 ...
 TO RUN THE PROGRAM:-
  1. Create a folder named "digital" in htdocs -> xammp in windows.
  2. Create two sub folders in "digital" named "assets" and "css".
  3. Download all .jpg files in "assets" and style.css in "css".
  4. Next download all the other .php files in notepad with the same .php extension in simply "digital".
  5. Start the xammp, admin and mysql then go to localhost/digital.php/.
